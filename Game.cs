...
namespace SFMLStart
{
    public class Game
    {
        ...
        public void Bind(string mBindName, Action mActionTrue, KeyCombination mKeyCombination, Action mActionFalse = null, int mBindDelay = 0) { Input.Bind(this, mBindName, mBindDelay, mActionTrue, mActionFalse, mKeyCombination); }
